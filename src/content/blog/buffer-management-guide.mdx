import { BufferConsumptionChart, ProjectTimelineChart } from '../../components/charts';
...
function calculateProjectBuffer(criticalChainTasks) {
  ...
  // 方法2：切割拼接法
  const totalDuration = criticalChainTasks.reduce((sum, task) => sum + task.duration, 0);
...
*想了解更多CCPM实践经验？请关注我们的后续文章，或联系CCPM360专家团队获取个性化咨询服务。*